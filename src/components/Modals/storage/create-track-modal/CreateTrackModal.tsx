...
import './CreateTrackModal.scss';

export interface ICreateTrackModalProps {
  onClose: () => void;
}

export const CreateTrackModal: FC<ICreateTrackModalProps> = ({ onClose }) => {
        ...
        <Modal className="create-track-modal-modal-width" onClose={onClose}>
          ...
          >
            <div className="create-track-modal">
              <Stepper
                className="create-track-modal__stepper"
                activeStep={activeStep}
                stepTitles={createTrackStepTitles}
              >
                <Step className="create-track-modal__step">
                  <Input
                    Icon={MdAudiotrack}
